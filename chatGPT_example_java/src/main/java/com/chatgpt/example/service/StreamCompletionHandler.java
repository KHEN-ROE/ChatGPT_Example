...
public class StreamCompletionHandler extends TextWebSocketHandler {
  ...
  public void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
    ...
    GPTCompletionChatRequest completionRequest = objectMapper.readValue(message.getPayload(),
  ...
  private void streamChatCompletion(String key, GPTCompletionChatRequest completionChatRequest) {
